  ...
  <div class="flex justify-center items-center">
    <div ref="invoiceWrap" class="flex flex-col space-y-4 w-3/4 bg-white rounded-md shadow-md p-4 overflow-y-auto" @click.prevent="">
      <form ref="invoiceForm" action="" @submit.prevent="submitInvoice">
        ...
        <span v-if="!editInvoice" class="h3">New Invoice</span>
        <span v-else class="h3">Edit Invoice</span>
        ...
        <div class="space-y-4 mt-4">
          ...
          <div>
            ...
            <div class="">
              ...
              <div class="flex justify-between pr-5 my-6">
                <p class="ml-20 text-sm">
                  Amount Due:
                </p>
                <p class="">
                  <span class="text-gray-400 text-xs align-top">$</span><span class="text-gray-800 text-2xl tracking-tighter align-top">{{ invoiceTotal }}</span><span class="text-gray-400 text-xs align-top">.00</span>
                </p>
              </div>
            </div>
        ...
        <div class="flex justify-between mt-4">
          ...
          <div>
            <button v-if="!editInvoice" class="bg-purple-400 text-white text-xs px-4 py-2 uppercase rounded-full" @click.prevent="saveDraft">
              Save Draft
            </button>
...
export default {
  ...
  methods: {
    ...
    async updateInvoice () {
      ...
      this.$router.push(`/dashboard/invoice/${this.id}`)
    },
    submitInvoice () {
      if (this.editInvoice) {
        this.updateInvoice()
